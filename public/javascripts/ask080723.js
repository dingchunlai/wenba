function checkreplyform(obj){
    ...
    if (ls_str > 0)
    {
        ...
        if(trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('办证刻章')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('法轮功')!=-1
            || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('电话')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('电 话')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('tel')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('qq')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('q q')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('Q Q')!=-1 || trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).indexOf('QQ')!=-1 )
            {
            alert("带特殊字样！");
            return false;
        } 
        var ro_length = trim(tinyMCE.getInstanceById("ro").getBody().innerHTML).length;
        if ( ro_length < 12){
            ls_str = "回答不详细，请重新输入";
            alert(ls_str);
            //            obj.ro.focus();
...
function Preview_discussion()
{
    ...
    var ut = encodeURI(document.getElementsByName("ut")[0].value)
    var url = "/user/preview_discussion"+"?ti="+ti+"&co="+co+"&ClassLevel1="+ClassLevel1+"&ut="+ut
    window.open(url, "_blank")
}
...
function checkform(obj){
    ...
    if(trim(obj.ti.value).indexOf('办证刻章')!=-1 || trim(obj.ti.value).indexOf('法轮功')!=-1 || trim(obj.ti.value).indexOf('tel')!=-1 || trim(obj.ti.value).indexOf('电话')!=-1 || trim(obj.ti.value).indexOf('电 话')!=-1 || trim(obj.ti.value).indexOf('q q')!=-1 || trim(obj.ti.value).indexOf('qq')!=-1 || trim(obj.ti.value).indexOf('Q Q')!=-1 || trim(obj.ti.value).indexOf('QQ')!=-1)
    {
        alert("带特殊字样！");
        return false;
    }
    ...
    if(trim(tinyMCE.getInstanceById("co").getBody().innerHTML) =="" || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).length ==0){
        alert("请输入问题详细内容");
        //        obj.co.focus();
        return false;
    }  
    if(trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('办证刻章')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('法轮功')!=-1
        || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('电话')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('电 话')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('tel')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('qq')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('q q')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('Q Q')!=-1 || trim(tinyMCE.getInstanceById("co").getBody().innerHTML).indexOf('QQ')!=-1 )
        {
        alert("带特殊字样！");
        return false;
    } 
    var leftChars1 = getLeftChars(obj.co,3000);
    if ( leftChars1 < 0){
...
function opendope()
{
    window.open('http://ask.51hejia.com/nipponpaint_wiki.html', '_self');
}
...
function checkdiscussionform(obj){
    gcv();
    ...
    if(obj.ClassLevel1.value=="" || obj.ClassLevel1.value==0){
        alert("请选择所属分类");
        return false;
    }
